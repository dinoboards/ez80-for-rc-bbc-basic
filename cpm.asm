...
COMDS:		DB	'AS', 'M'+80h		; ASM
		...
		DB	'VDP_CLEAR_ME', 'M'+80h
		D24	STAR_VDP_CLEAR_MEM
		DB	'VDP_CMD_LIN', 'E'+80h
		D24	STAR_VDP_CMD_LINE
		DB	'VDP_CMD_VDP_TO_VRA', 'M'+80h
		D24	STAR_VDP_CMD_VDP_TO_VRAM
		DB	'VDP_DRAW_LIN', 'E'+80h
		D24	STAR_DRAW_LINE
		DB	'VDP_GRAPHIC_MOD', 'E'+80h
		D24	STAR_VDP_GRAPHIC_MODE
		DB	'VDP_REGW', 'R'+80h
		D24	STAR_VDP_REGWR
		DB	'VDP_STATU', 'S'+80h
		D24	STAR_VDP_STATUS
...
KY_CUR_UP:	EQU	'E'&1FH	;CURSOR UP 11
KY_CUR_DOWN:	EQU	'X'&1FH	;CURSOR DOWN 10
KY_START_LINE:	EQU	'A'&1FH	;START OF LINE  9
...
KY_CUR_LEFT:	EQU	'S'&1FH	;CURSOR LEFT 4
KY_CUR_RIGHT:	EQU	'D'&1FH	;CURSOR RIGHT 3
