...
OPEN1:
	...
	; todo MODIFY TO TEST 3 BYTES ARE 0
	LD	A,(HL)
	DEC	HL
	OR	(HL)
...
OPEN2:	LD	DE,(FREE)	;FREE SPACE POINTER
	; TODO: need to load 24 bit address into DE
	LD	(HL),E
	INC	HL
	LD	(HL),D
	LD	A,B		;CHANNEL (1-7)
...
GETEXT:	CALL	FIND
	EX	DE,HL
	LD	DE,FCB ; todo invalid address of FCB
	LD	BC,36
	PUSH	DE
	LDIR			;COPY FCB
	EX	DE,HL
...
GETPTR:	CALL	FIND
	...
	DEC	HL
GETPT1:	DEC	HL
	; todo pointer arthimatic is probably wrong
	LD	D,(HL)
	DEC	HL
	LD	E,(HL)
	DEC	HL
...
; Destroys: A,F
;
	; TODO COPY FCB DATA FROM DE TO RESERVE BLOCK IN 64K PAGE
	; TODO SET HL BUFFER IN 64K BASE - ASSUME 128 BYTES!
READ:
	PUSH	HL
...
;
WRITE:
	PUSH	DE				; TRANSFER DATA TO THE 64K PAGE
	PUSH	BC
	LD	DE, DISK_BUFFER
	LD	BC, 128
	LDIR
...
OSCLI5:	BIT	7,(HL)
	...
	; TODO - LOAD 3 byte value into HL
	LD	A,(HL)
	INC	HL
	LD	H,(HL)
	LD	L,A
...
TRPCNT:	DEFB	10
_TABLE:
TABLE:	DEFS	8*3		;FILE BLOCK POINTERS
FLAGS:	DEFB	0
INKEY:	DEFB	0
EDPTR:	d24	0
_OPTVAL:
